...
void setup() {
  ...
  myFile = SD.open("test.csv", FILE_WRITE); // เปิดไฟล์ที่ชื่อ test.txt เพื่อเขียนข้อมูล โหมด FILE_WRITE
  ...
  // เปิดไฟล์เพื่ออ่าน
  myFile = SD.open("test.csv"); // สั่งให้เปิดไฟล์ชื่อ test.txt เพื่ออ่านข้อมูล
  if (myFile) {
