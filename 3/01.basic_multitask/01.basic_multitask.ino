...
void setup() {
  ...
  task1.start( sonic3, NULL, 56);   // เริ่ม task 3 ให้ไปเรียก sonic3 ทำงาน
  task2.start( sonic4, NULL, 56);   // เริ่ม task 4 ให้ไปเรียก sonic4 ทำงาน
  task1.start( sonic5, NULL, 56);   // เริ่ม task 5 ให้ไปเรียก sonic5 ทำงาน
